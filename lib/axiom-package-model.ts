...
export const axiomPackageModels: Record<AxiomPackageKey, AxiomPackageModel> = {
  ...
  workflow_blueprint: {
    ...
    reportType: "implementation_blueprint",
    serviceRoute: "package",
    canBuyDirectly: true,
    canRequestAsProposal: false,
  ...
  workflow_stewardship: {
    ...
    reportType: "optimisation_review",
    serviceRoute: "package",
    canBuyDirectly: true,
    canRequestAsProposal: true,
  ...
  departmental_ecosystem: {
    ...
    reportType: "ecosystem_architecture",
    serviceRoute: "package",
    canBuyDirectly: true,
    canRequestAsProposal: true,
  ...
  enterprise_architecture_system: {
    ...
    reportType: "enterprise_architecture_system",
    serviceRoute: "both",
    canBuyDirectly: true,
    canRequestAsProposal: true,
